...
public class StudentRegistrationForm {
    WebDriver driver;
    String absolutePath = "C:\\Users\\Naser Ahmed\\IdeaProjects\\Automation/Test_Data/Mock_Data.csv";

    CSVReader csvReader = new CSVReader(new FileReader(absolutePath));
    String[] cells = csvReader.readNext();

    public StudentRegistrationForm() throws IOException, CsvValidationException {
    }
